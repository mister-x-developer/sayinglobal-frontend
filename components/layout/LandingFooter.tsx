        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-fg-muted">
              ...
              <li>
                <Link href="/listings/nearby" className="hover:text-fg transition-colors">
                  {t('nav.nearby')}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-fg-muted">
              ...
              <li>
                <a href="https://t.me/sayinglobal_bot" target="_blank" rel="noopener noreferrer" className="hover:text-fg transition-colors">
                  Telegram Bot
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-fg-muted">
              <li>
                <a href="https://t.me/sayinglobal" target="_blank" rel="noopener noreferrer" className="hover:text-fg transition-colors inline-flex items-center gap-2">
              ...
              <li>
                <a href="https://instagram.com/sayinglobal" target="_blank" rel="noopener noreferrer" className="hover:text-fg transition-colors inline-flex items-center gap-2">
              ...
              <li>
                <a href="https://youtube.com/@sayinglobal" target="_blank" rel="noopener noreferrer" className="hover:text-fg transition-colors inline-flex items-center gap-2">
