...
export default function GuidePage() {
  ...
  const statuses = {
    good: {
      ...
      ru: 'Хорошо',
      en: 'Good',
      desc: 'Hech qanday cheklovlar yoʻq. Barcha funksiyalardan toʻliq foydalanishingiz mumkin: eʻlon yaratish, chat, va boshqalar.'
    },
    warning: {
      uz: 'Ogohlantirish',
      ...
      ru: 'Предупреждение',
      en: 'Warning',
      desc: 'Kichik cheklovlar: eʻlonlar soni cheklanishi mumkin, chat faoliyati nazorat qilinadi.'
    },
    restricted: {
      uz: 'Cheklangan',
      'uz-cyrl': 'Чекланган',
      ru: 'Ограничен',
      en: 'Restricted',
      desc: 'Eʻlon yaratish va chat faoliyati cheklanadi. Faqat mavjud eʻlonlarni koʻra olasiz.'
    },
    blocked: {
      uz: 'Bloklangan',
      'uz-cyrl': 'Блокланган',
      ru: 'Заблокирован',
      en: 'Blocked',
      desc: 'Hisob toʻliq muzlatiladi. Barcha eʻlonlar yashiriladi, hech qanday amal bajarib boʻlmaydi.'
    }
  };
