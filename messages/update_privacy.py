...
locales = {
    'uz.json': {
        ...
        "dataCollectionTitle": "1. Ma'lumotlarni to'plash va foydalanish",
        "dataCollectionBody": "SAYIN GLOBAL platformasi xizmatlardan foydalanish jarayonida foydalanuvchilarning ismini, telefon raqamini, ruxsat etilganda GPS joylashuvini hamda qurilma turini (IP, browser) to'playdi. Bu ma'lumotlar faqatgina e'lonlarni ko'rsatish va xavfsiz muhitni ta'minlash uchun ishlatiladi.",
        "dataUsageTitle": "2. Uchinchi tomonlar va ma'lumotlarni almashish",
        "dataUsageBody": "Foydalanuvchining shaxsiy ma'lumotlari (masalan, telefon raqam) uchinchi shaxslarga tijorat maqsadida sotilmaydi. Telefon raqamingiz faqatgina tizimga kirish (Telegram orqali) va profil orqali aloqa qilishga ruxsat bersangizgina e'londa ko'rsatiladi.",
        "locationTitle": "3. Joylashuv ma'lumotlari (GPS)",
        "locationBody": "Joylashuv ma'lumotlari faqatgina \"Yaqin atrof\" xizmati uchun va xaritada e'lon joylashuvini belgilash uchun ishlatiladi. Sizning aniq lokatsiyangiz boshqa foydalanuvchilarga xarita belgisi (pin) shaklida ko'rsatiladi.",
        ...
        "rightsTitle": "5. Foydalanuvchi huquqlari va Hisobni o'chirish",
        "rightsBody": "Foydalanuvchi istalgan vaqtda o'z hisobini to'liq o'chirib tashlash huquqiga ega. Hisob o'chirilganda, unga tegishli barcha e'lonlar, chatlar va rasm fayllari tizimdan tiklanmas tarzda tozalanadi.",
        ...
        "changesTitle": "7. Siyosatga kiritiladigan o'zgartirishlar",
        "changesBody": "SAYIN GLOBAL ma'muriyati mazkur Maxfiylik Siyosatiga o'zgartirishlar kiritish huquqini o'zida saqlab qoladi. Katta o'zgarishlar bo'lganda, platforma orqali sizga xabar beriladi.",
        "contactTitle": "8. Biz bilan bog'lanish",
        "contactBody": "Maxfiylik siyosati bo'yicha savollaringiz, takliflaringiz bo'lsa, rasmiy Telegram manzilimiz (@sayinglobal_support) yoki elektron pochta (support@sayinglobal.uz) orqali biz bilan bog'lanishingiz mumkin."
    },
    'uz-cyrl.json': {
    ...
    'en.json': {
        ...
        "locationBody": "Location data is only used for the 'Nearby' feature and to pin the listing's location on the map. Your exact location will be shown to other users as a map pin.",
